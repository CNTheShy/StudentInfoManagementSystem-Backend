...
public class SchoolInfoServiceImpl implements SchoolInfoService {
    ...
    public  Academy getAcademyByName(String academyName) {
        ...
        if (academyName == null) {
            ...
            int academyId = academyMapper.findAcademyIdByName(academyName);
            academy = academyMapper.findAcademyBaseInfoById(academyId);
        }
        return academy;
    }
    ...
    public  Academy getAcademyById(int academyId) {
        return academyMapper.findAcademyBaseInfoById(academyId);
    }
